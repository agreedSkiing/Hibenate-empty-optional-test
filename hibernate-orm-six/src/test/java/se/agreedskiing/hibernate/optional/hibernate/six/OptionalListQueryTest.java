...
class OptionalListQueryTest extends PostgresContainer {
  ...
  static Stream<Arguments> with_miss_matching_filter_inputs() {
    ...
    return Stream.of(
      Arguments.of(
        "Ids and Fields with others empty",
        0,
        ids_one_exists,
        fields_one_exists,
        new ArrayList<UUID>()
      ...
      Arguments.of(
        "Fields and Uus with others empty",
        0,
        new ArrayList<Long>(),
        fields_one_exists,
        uus_one_exists
